...
namespace UniversityProgram.Api.Migrations
{
    ...
    [Migration("20250214212238_Add_Address")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniversityProgram.Api.Entities.AddressBase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UniversityProgram.Api.Entities.AddressBase", b =>
                {
                    b.HasOne("UniversityProgram.Api.Entities.Student", "Student")
                        .WithOne("Address")
                        .HasForeignKey("UniversityProgram.Api.Entities.AddressBase", "StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
